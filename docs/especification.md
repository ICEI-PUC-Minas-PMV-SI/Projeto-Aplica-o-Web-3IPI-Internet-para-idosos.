...
|--------------------|------------------------------------|----------------------------------------|
|Senhor(a)           | Aprender computação básica         | Não depender de terceiros              |
|Administrador       | Ensinar de forma simples           | Ajudar com dependência computacional   |
...
|RNF-003| Utilizar de temas escuros e fontes grandes para facilitar leitura  |  ALTA |
